...
app.layout = html.Div(children=[
    ...
    dcc.RangeSlider(
        ...
        marks={i: str(i) for i in range(0, 100001, 2500)},
        min=0,
        max=10000,
        step=1,
        value=[0, 10000]
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All':
        ...
        fig_pie_chart_all = px.pie(spacex_df, values=site_success_proportions.values, names=site_success_proportions.index,
            title='Firststage landing success summary all sites')
        ...
        fig_pie_chart_by_site = px.pie(names=value_counts.index, values=value_counts.values, title='First stage success and failure summary for site ' + entered_site)
